...
- Clicking on <img src="assets/info.png" alt="Logo" width="25"> button will reveal official OpenCV documentation for the selected operation in your internet browser.
