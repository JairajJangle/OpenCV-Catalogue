...
HoughLines::HoughLines()
{
    ...
    rhoLineEditLayout = new LineEditLayout("rho", *rho);
    thetaLayout = new LineEditLayout("theta", *theta, 150);
    thresholdLayout = new LineEditLayout("threshold", *threshold);
    srnLayout = new LineEditLayout("srn", *srn);
    stnLayout = new LineEditLayout("stn", *stn);
...
cv::Mat HoughLines::getProcessedImage(cv::Mat inputImage) try
{
