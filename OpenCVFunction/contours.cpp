...
cv::Mat Contours::getProcessedImage(cv::Mat inputImage) try
{
...
void Contours::modeChanged(int value)
{
    mode = value;
}
void Contours::methodChanged(int value)
{
    method = value;
}

void Contours::initWidget()
{
    offsetLEL =
