...
cv::Mat HistogramCalculation::getProcessedImage(cv::Mat inputImage) try
{
...
void HistogramCalculation::initWidget()
{
    uniformCB = new QCheckBox("uniform");
    accumulateCB = new QCheckBox("accumulate");
