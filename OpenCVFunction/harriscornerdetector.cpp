...
HarrisCornerDetector::HarrisCornerDetector()
{
    ...
    blockSizeLayout = new LineEditLayout("blockSize", *blockSize);
    apertureSizeLayout = new LineEditLayout("ksize", *apertureSize);
    kLayout = new LineEditLayout("k", *k);
...
cv::Mat HarrisCornerDetector::getProcessedImage(cv::Mat inputImage)try
{
...
void HarrisCornerDetector::threshChanged(int value)
{
    threshold = value;
}

void HarrisCornerDetector::applyClicked()
{
...
void HarrisCornerDetector::resetClicked()
{
    *blockSize = 2;
    *apertureSize = 3;
    *k = 0.04;
...
void HarrisCornerDetector::borderTypeChanged(int index)
{
    *borderType = borderTypeComboBox->itemData(index);
}

void HarrisCornerDetector::initWidget()
{
    borderTypeComboBox = new QComboBox();
    threshSliderLayout = new SliderLayout("Threshold\n[0-255]",
                                                            threshold, 0, 255, 190);
